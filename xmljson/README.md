...
If you have a choice between getting data as XML or JSON, get whichever you're more comfortable with, unless the data is going to be plugged directly into a web application, in which case you want JSON, because it integrates smoothly into JavaScript code.
